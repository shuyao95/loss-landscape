...
NASNet = Genotype(
	normal=[('sep_conv_5x5', 1), ('sep_conv_3x3', 0), ('sep_conv_5x5', 0), ('sep_conv_3x3', 0),
	        ...
	        ('sep_conv_3x3', 1), ('skip_connecåt', 1),
	        ],
...
SNAS_CONN2 = Genotype(normal=[('sep_conv_3x3', 0), ('sep_conv_3x3', 1), ('skip_connect', 2), ('dil_conv_3x3', 0), ('skip_connect', 1), ('skip_connect', 3), ('skip_connect', 2), ('sep_conv_3x3', 4)], normal_concat=[2, 3, 4, 5], reduce=[('max_pool_3x3', 1), ('max_pool_3x3', 0), ('skip_connect', 2), ('max_pool_3x3', 2), ('max_pool_3x3', 3), ('skip_connect', 1), ('dil_conv_5x5', 4), ('max_pool_3x3', 4)], reduce_concat=[2, 3, 4, 5])
SNAS_CONN3 = Genotype(normal=[('sep_conv_3x3', 0), ('sep_conv_3x3', 1), ('skip_connect', 0), ('dil_conv_3x3', 0), ('skip_connect', 1), ('skip_connect', 2), ('skip_connect', 1), ('sep_conv_3x3', 2)], normal_concat=[2, 3, 4, 5], reduce=[('max_pool_3x3', 0), ('max_pool_3x3', 1), ('skip_connect', 0), ('max_pool_3x3', 1), ('max_pool_3x3', 3), ('skip_connect', 3), ('dil_conv_5x5', 1), ('max_pool_3x3', 0)], reduce_concat=[2, 3, 4, 5])
SNAS_CONN4 = Genotype(normal=[('sep_conv_3x3', 0), ('sep_conv_3x3', 1), ('skip_connect', 1), ('dil_conv_3x3', 0), ('skip_connect', 1), ('skip_connect', 0), ('skip_connect', 1), ('sep_conv_3x3', 4)], normal_concat=[2, 3, 4, 5], reduce=[('max_pool_3x3', 0), ('max_pool_3x3', 1), ('skip_connect', 0), ('max_pool_3x3', 2), ('max_pool_3x3', 2), ('skip_connect', 3), ('dil_conv_5x5', 0), ('max_pool_3x3', 2)], reduce_concat=[2, 3, 4, 5])
...
DARTS_IMP = Genotype(
	normal=[('sep_conv_3x3', 0), ('sep_conv_3x3', 1), ('sep_conv_3x3', 0), ('sep_conv_3x3', 1),
	        ('sep_conv_3x3', 0), ('sep_conv_3x3', 1), ('sep_conv_3x3', 0), ('sep_conv_3x3', 1)],
	normal_concat=[2, 3, 4, 5],
	reduce=[('sep_conv_3x3', 0), ('sep_conv_3x3', 1), ('sep_conv_3x3', 0), ('sep_conv_3x3', 1),
	        ('sep_conv_3x3', 0), ('sep_conv_3x3', 1), ('sep_conv_3x3', 0), ('sep_conv_3x3', 1)],
	reduce_concat=[2, 3, 4, 5])
...
def nasnet_imp(auxiliary):
	return NetworkCIFAR(C=36, num_classes=10, layers=20, auxiliary=auxiliary, genotype=NASNet_IMP)

def amoebanet_imp(auxiliary):
	return NetworkCIFAR(C=36, num_classes=10, layers=20, auxiliary=auxiliary, genotype=AmoebaNet_IMP)

def snas_imp(auxiliary):
	return NetworkCIFAR(C=36, num_classes=10, layers=20, auxiliary=auxiliary, genotype=SNAS_IMP)

def enas_imp(auxiliary):
	return NetworkCIFAR(C=36, num_classes=10, layers=20, auxiliary=auxiliary, genotype=ENAS_IMP)

def darts_imp(auxiliary):
	return NetworkCIFAR(C=36, num_classes=10, layers=20, auxiliary=auxiliary, genotype=DARTS_IMP)
